...
const perguntas = [
  {
    pergunta:
      "Qual órgão brasileiro fornece dados sobre queimadas utilizados pelo Eco Fusion?",
  ...
  {
    pergunta:
      "Segundo dados do INPE, qual bioma brasileiro costuma registrar os maiores números de focos de queimadas?",
    alternativas: ["Cerrado", "Mata Atlântica", "Pampa", "Pantanal"],
    correta: 0,
  },
  {
  ...
  },
  {
    ...
    alternativas: ["ODS 4", "ODS 7", "ODS 13", "ODS 16"],
    correta: 2,
  },
  {
  ...
  {
    pergunta:
      "Qual dessas condições climáticas não aumenta o risco de queimadas",
    alternativas: [
  ...
  {
    pergunta:
      "Qual impacto financeiro pode ser causado por uma grande queimada?",
    alternativas: [
      "Perda de vegetação",
...
function mostrarPergunta() {
  ...
  btnVoltar.style.display = perguntaAtual === 0 ? "none" : "block";
...
function salvarResposta() {
  ...
  if (resposta) {
    respostas[perguntaAtual] = Number(resposta.value);
  }
}
...
btnAvancar.addEventListener("click", () => {
  ...
  if (!resposta) {
    mensagemErro.textContent = "Selecione uma alternativa antes de continuar.";
